...
DNA_BOUND = [0, 5]       # solution upper and lower bound
N_GENERATIONS = 100
MUT_STRENGTH = 10.       # initial step size (dynamic mutation strength)
...
def kill_bad(parent, kid):
    ...
    MUT_STRENGTH *= np.exp(1/np.sqrt(DNA_SIZE+1) *
                           (ps - p_target)/(1 - p_target))
    return parent
